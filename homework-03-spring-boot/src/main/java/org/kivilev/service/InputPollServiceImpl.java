...
public class InputPollServiceImpl implements InputPollService {
    ...
    public InputPollServiceImpl(InputStream inputStream, PrintStream printStream, MessageSourceLocale messageSource) {
    ...
    public PollResult processQuestionsAndAnswers(List<Question> questions, int correctAnswerMinimumCount) {
        ...
        for (var question : questions) {
            ...
            printStream.print(messageSource.getMessage("enter.answers", new String[]{}));
