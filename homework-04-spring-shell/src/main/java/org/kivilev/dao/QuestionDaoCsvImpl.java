...
import org.kivilev.config.QuestionSourceConfig;
...
public class QuestionDaoCsvImpl implements QuestionDao {
    ...
    public QuestionDaoCsvImpl(CsvMapper csvMapper, QuestionSourceConfig questionSourceConfig) {
        this.csvMapper = csvMapper;
        this.csvFileName = questionSourceConfig.getCsvFileName();
    }
